...
import { ArrowLeft, ArrowRight, Award, BookOpen, CheckCircle, ChevronDown, Clock, Play, Target, User, X } from "lucide-react";
        ...
        return (
            <div className={courseDetailStyles.notFoundContainer}>
                <div className={courseDetailStyles.notFoundContent}>
                    ...
                    <button className={courseDetailStyles.notFoundButton} onClick={() => navigate("/courses")}>Go to Courses</button>
                </div>
            </div>
        )
    }
            ...
            <div className={`${courseDetailStyles.mainContainer} ${isPageLoaded ? courseDetailStyles.containerVisible : courseDetailStyles.containerHidden}`}>
                ...
                <div className={courseDetailStyles.header}>
                    <div className={courseDetailStyles.badge}>
                        ...
                        <span className={courseDetailStyles.badgeText}>{isCourseFree ? "Free Course" : "Premium Course"}</span>
                    </div>
                    ...
                    <div className={`${courseDetailStyles.statsContainer} animation-delay-300`}>
                        <div className={courseDetailStyles.statItem}>
                            ...
                            <span className={courseDetailStyles.statText}>{fmtMinutes(totalMinutes)}</span>
                        </div>
                        <div className={courseDetailStyles.statItem}>
                            <BookOpen className={courseDetailStyles.statIcon} />
                            <span className={courseDetailStyles.statText}>{(course.lectures || []).length} Lectures</span>
                        </div>
                        <div className={`${courseDetailStyles.teacherStat} ${isTeacherAnimating ? courseDetailStyles.teacherStatAnimating : ''}`}>
                            <User className={courseDetailStyles.statIcon} />
                            <span className={courseDetailStyles.statText}>{course.teacher}</span>
                        </div>
                    </div>
                </div>
