        ...
        <section className={testimonialStyles.section}>
            <div className={testimonialStyles.container}>
                ...
                <h2 className={testimonialStyles.title}>
                    <span className={testimonialStyles.titleGradient}>Voices of Success</span>
                </h2>
                <p className={testimonialStyles.subtitle}>Discover how our learners transformed their careers with hands-on projects and expert mentorship.</p>
            </div>
                            ...
                            <div className={testimonialStyles.content}>
                                <div className={testimonialStyles.avatarContainer}>
                                    <div className={testimonialStyles.avatarWrapper}>
                                        <img src={t.avatar} alt={t.name} className={testimonialStyles.avatarImage} loading='lazy' />
                                    </div>
                                ...
                                <div className={testimonialStyles.userInfo}>
                                    <div className={testimonialStyles.userHeader}>
                                        ...
                                        <div className={testimonialStyles.ratingContainer}>
                                            <div className={testimonialStyles.starsContainer}>{renderStars(t.rating)}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
